...
class MarketDB:
    def __init__(self):
        ...
        self.conn = pymysql.connect(host='localhost', port=3306, user='root', password='Hyeeunnim18',
    ...
    def get_daily_price(self, code, start_date=None, end_date=None):
        """KRX 종목별 시세를 데이터프레임 형태로 반환
            ...
            - start_date : 조회 시작일('2020-01-01'), 미입력 시 1년전 오늘
            - end_date   : 조회 종료일('2021-12-31'), 미입력 시 오늘 날짜
        """
